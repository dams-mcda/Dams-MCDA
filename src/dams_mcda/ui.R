	...
	navlistPanel(
		...
		tabPanel("Start Here",
			...
			HTML(
				 ...
				 <ol>\
					 <li> Remove dam </li>\
					 <li> Improve fish passage </li> \
					 <li> Improve hydropower generation </li> \
					 <li> Improve hydropower generation AND fish passage</li> \
      ...
      # generate event
			...
			div(id="generated-output",
				...
				#tableOutput("FilledCriteriaTable"), # for debugging criteria table
				  ...
				  HTML("<br>recall that the decision criteria ratings under every decision alternative were required to sum to 1. Here, the colored decision criteria segments within each decision alternative bar show the contribution of each decision criterion toward each decision\
