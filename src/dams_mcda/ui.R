...
ui <- shinyUI(fluidPage(
	...
	navlistPanel(
		...
		tabPanel("Multi-Criteria Decision Analysis",
			...
			h2("Introduction"),
			HTML(
				 "This R Shiny app supports decision making about a dam, using a set of decision criteria and decision alternatives identified using data from dam decision-maker interviews. The tool uses a Weighted Sum approach to Multi-Criteria Decision Analysis (MCDA) to compare \
				 ...
				 <h4>Your Task</h4> What do you envision for the future of this set of dams? Your task is to consider each of the decision alternatives for decisions across the set of dams:<br>\

				 <ol>\
					 <li> Remove dam </li>\
					 <li> Improve fish passage facilities </li> \
					 <li> Improve hydropower generation </li> \
					 <li> Improve hydropower generation AND fish passage facilities</li> \
					 <li> Keep and maintain dam</li> \
				 </ol>\
				 ...
				 <ol>\
					 ...
					 <li> \
						 River recreation area (square miles or kilometers): estimated area of river that may increase or decrease with a dam decision alternative, combines functional area for whitewater and flatwater recreation defined by Roy et al. (2018). \
					 </li>\
					 ...
					 <li> \
						 Annuitized project costs (2018 $USD): estimated total project costs (capital and operation & maintenance) on an annual basis using a 10% discount rate. \
					 </li>\

					 <li> \
						  Number of properties impacted: estimated number based on potential changes in viewshed or property value (Roy et al., 2018).\
					 </li>\

					 <li> \
						  Breach damage potential (unitless): a proxy for safety based on the State hazard rating, which indicates the potential for downstream property damage, injury, and death in the case of dam breach. \
					 </li>\

					 <li> \
						  Annual electricity generation (MWh/yr): estimate based on nameplate capacity. \
					 </li>\

					 <li> \
						  Carbon dioxide (CO2) emissions reduction (lbs or metric tonnes per year):  estimated based on avoided fossil fuel-generated electricity, using the State's energy mix. \
					 </li>\

					 <li> \
						  Indigenous cultural heritage (unitless): to convey the importance of the decision alternative for preserving/restoring the culture of indigenous people. \
					 </li>\

					 <li> \
						  Town/city identity (unitless): rating provided by decision-maker to convey the importance of the decision alternative for preserving the existing identity of the community of town/city residents. \
					 </li>\

					 <li> \
						  Industrial historical value (unitless): rating provided by the decision maker to convey the importance of the decision alternative for preserving/restoring the industrial historical value of the infrastructure. \
					 </li>\

					 <li> \
						  Aesthetic value (unitless): rating provided by the decision maker to convey the importance of the decision alternative for improving or preserving the aesthetics (e.g, appearance, scenic value, smell, sound). \
					 </li>\
				 </ol><br>\

				 Toggle through the DECISION ALTERNATIVE pages at left to compare criteria under a single decision alternative and click UPDATE button to view decision alternative-specific results and mark the alternative COMPLETE. After you have finished rating criteria under every ALTERNATIVE tab, \
